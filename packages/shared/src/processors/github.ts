...
export class GitHubProcessor extends BaseProcessor {
  ...
  private async processRepository(repoInfo: GitHubRepoInfo): Promise<GitHubFileContent[]> {
  ...
  private formatRepositoryContent(files: GitHubFileContent[], repoInfo: GitHubRepoInfo): string {
